        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end gap-2">
            <button
              ...
              className="px-4 py-2 bg-[#F47A8A] text-white rounded hover:bg-[#D95F71] focus:outline-none transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
            >
              {isSubmitting && (
...
export default function AIQAuthPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#343541]">
      {/* Green Banner */}
      <div className="bg-[#F47A8A] text-white py-4 px-6 text-center">
