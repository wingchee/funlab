...
import { PixelCraftBridge } from '@/components/PixelCraft/PixelCraftBridge';
...
const Home = (props: any) => {
  ...
  return (
    ...
    >
      <Head>
        <title>{workflow} | PixelCraft</title>
        <meta name="description" content={workflow} />
        <meta
          name="viewport"
          content="height=device-height ,width=device-width, initial-scale=1, user-scalable=no"
        />
        <link rel="icon" href="/bead-editor/favicon1.png" />
      </Head>
      {selectedConversation && (
        <main
          className={`flex h-screen w-screen flex-col bg-[#FEF4F5] text-sm text-[#1A1A18] dark:text-white ${lightMode}`}
        >
