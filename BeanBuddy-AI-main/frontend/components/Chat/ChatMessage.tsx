              ...
              {isEditing ? (
                <div className="flex w-full flex-col">
                  ...
                  <div className="mt-10 flex justify-center space-x-4">
                    <button
                      className="h-[40px] rounded-md border border-neutral-300 px-4 py-1 text-sm font-medium text-neutral-700 enabled:hover:bg-[#F47A8A] disabled:opacity-50"
                  ...
                  { 
                    ...
                    <>
                      {messagedCopied ? 
                        <IconCheck
                          size={20}
                          className="text-[#F47A8A] dark:text-[#F47A8A]"
                          id={message?.id}
                        /> : 
                        <button
                          className="text-[#F47A8A] hover:text-gray-700 dark:text-[#F47A8A] dark:hover:round-gray-300"
                          onClick={copyOnClick}
                      ...
                      <button
                        className="text-[#F47A8A] hover:text-gray-700 dark:text-[#F47A8A] dark:hover:text-gray-300"
