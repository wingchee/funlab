  ...
  if(content.input_type === 'notification'){
    toast.custom((t) => (
     <div
      ...
      >
        <IconInfoCircle size={16} className="text-[#F47A8A]" />
        ...
        {content.input_type === "text" && (
          <div>
            ...
            <div className="flex justify-end mt-4 space-x-2">
              ...
              <button className="px-4 py-2 bg-[#F47A8A] text-white rounded" onClick={handleTextSubmit}>
                Submit
              </button>
            </div>
          </div>
          ...
          <div>
            <div className="flex justify-end mt-4 space-x-2">
              {content.options.map((option) => (
                <button
                  key={option.id}
                  className={`px-4 py-2 ${option?.value?.includes('continue') ? 'bg-[#F47A8A]' : 'bg-slate-800'} text-white rounded`}
        ...
        {content.input_type === "radio" && (
          <div>
              ...
              {content.options.map((option) => (
                <div key={option.id} className="flex items-center">
                  <input
                    ...
                    className="mr-2 text-[#F47A8A] focus:ring-[#F47A8A]"
                  />
            ...
            <div className="flex justify-end mt-4 space-x-2">
              ...
              <button 
                className="px-4 py-2 bg-[#F47A8A] text-white rounded" 
